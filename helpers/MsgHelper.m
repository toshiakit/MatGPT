    ...
    methods (Access=public,Static)
        ...
        function [contextwindow,cutoff] = getModelDetails(modelName)
            ...
            models = [ ...
                ...
                struct('name','gpt-4o-mini','attributes',struct('contextwindow',128000,'cutoff','Oct 2023')), ...
                struct('name','gpt-4o-mini-2024-07-18','attributes',struct('contextwindow',128000,'cutoff','Oct 2023')), ...
        ...
        function s = startupMessages()
            ...
            s.content = [s.content,"<strong>What's New</strong>: " + ... 
                ...
                "<li>Supports vision mode in eligibile models (i.e. GPT-4o mini) with .jpg, .png or .gif images</li>" + ...
